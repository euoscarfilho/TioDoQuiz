...
// export const stopRecordBtn = document.getElementById('stop-record-btn'); // Removido na limpeza anterior
...
export const soundFinal = document.getElementById('sound-final');

// --- CONSTANTES DE PADRÃO ---
export const DEFAULT_LOGO_URL = './files/logo.png';
export const DEFAULT_VIDEO_URL = './files/BG.mp4';
export const DEFAULT_LOGO_SIZE = '200'; // px (AJUSTE: Aumentado de 200 para 220)

// --- VARIÁVEIS DE ESTADO ---
export let downloadTimeoutId = null; // ID do timeout para o botão de download
